...
```
Установите значения нужных лиг и создайте суперпользователя:
```bash
...
│   └── celery_app.py
├── scripts/
│   ├── add_league_entries.sh
│   ├── create_superuser.sh
│   ├── reset_table_match.sh
...
fav_check_parser.py: Реализация парсера проверки избранного для Akty.com
